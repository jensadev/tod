...
module.exports = {
    intro: (content) => {
        return `<section class="part__introduction flow" role="inledning">${content}</section>`;
    },
    instruktioner: (content) => {
        return `<section class="part__instructions flow" role="instruktioner">${content}</section>`;
    },
    uppgifter: (content, lead) => {
        return `<section class="part__assignments flow" role="uppgifter"><header><h2 id="uppgifter">Uppgifter</h2>${ lead ? lead : '' }</header>${content}</section>`;
    },
    bas: (content) => {
